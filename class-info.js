            ...
            const buildLed = (key) => {
                ...
                return (rawValue) => {
                    if (rawValue === null || rawValue === undefined) {
                        return `<span class="mini-led-wrap"><span class="led na"></span><span>${config.label}</span></span>`;
                    }
                    ...
                    const color = `hsl(${hue} 88% 48%)`;
                    return `<span class="mini-led-wrap"><span class="led" style="--led-color:${color};--led-glow:hsl(${hue} 92% 55% / 0.6)"></span><span>${config.label}</span></span>`;
                };
            };
